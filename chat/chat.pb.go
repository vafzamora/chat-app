...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x75, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x70, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x31, 0x0a, 0x04,
	0x43, 0x68, 0x61, 0x74, 0x12, 0x29, 0x0a, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x71, 0x0a, 0x0b, 0x43, 0x68, 0x61,
	0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2a, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x6e,
	0x65, 0x63, 0x74, 0x12, 0x0c, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e,
	...
	0x63, 0x68, 0x61, 0x74, 0x2d, 0x61, 0x70, 0x70, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70,
...
var file_chat_chat_proto_goTypes = []interface{}{
	...
	(*Client)(nil),                // 2: chat.Client
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 4: google.protobuf.Empty
}
var file_chat_chat_proto_depIdxs = []int32{
	3, // 0: chat.Message.timestamp:type_name -> google.protobuf.Timestamp
	0, // 1: chat.Chat.messages:type_name -> chat.Message
	2, // 2: chat.ChatService.Connect:input_type -> chat.Client
	0, // 3: chat.ChatService.SendMessage:input_type -> chat.Message
	0, // 4: chat.ChatService.Connect:output_type -> chat.Message
	4, // 5: chat.ChatService.SendMessage:output_type -> google.protobuf.Empty
