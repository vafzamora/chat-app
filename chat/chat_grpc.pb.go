...
type ChatServiceClient interface {
	Connect(ctx context.Context, in *Client, opts ...grpc.CallOption) (ChatService_ConnectClient, error)
...
func (c *chatServiceClient) Connect(ctx context.Context, in *Client, opts ...grpc.CallOption) (ChatService_ConnectClient, error) {
...
type ChatServiceServer interface {
	Connect(*Client, ChatService_ConnectServer) error
...
func (UnimplementedChatServiceServer) Connect(*Client, ChatService_ConnectServer) error {
